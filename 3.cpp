...
void TestAreSynonyms() {
    ...
    synonyms.Add("tune"s, "guitar"s);
    synonyms.Add("guitar"s, "music"s);
    assert(synonyms.AreSynonyms("tune"s, "guitar"s));
    assert(synonyms.AreSynonyms("music"s, "guitar"s));

    synonyms.Add("music"s, "drums"s);
    synonyms.Add("drums"s, "melody"s);
    synonyms.AreSynonyms("music"s, "drums"s);
    synonyms.AreSynonyms("drums"s, "melody"s);
}
