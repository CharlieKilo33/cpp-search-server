...
#ifndef PRACTICUM_SEARCH_SERVER_SEARCH_SERVER_H_
#define PRACTICUM_SEARCH_SERVER_SEARCH_SERVER_H_
...
class SearchServer {
 public:
  ...
  [[maybe_unused]] [[nodiscard]] std::tuple<std::vector<std::string>,
                                            DocumentStatus> MatchDocument(const std::string &raw_query,
...
#endif //PRACTICUM_SEARCH_SERVER_SEARCH_SERVER_H_
